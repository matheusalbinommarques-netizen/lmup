...
declare module '$app/types' {
  export interface AppTypes {
    ...
    Asset():
      ...
      | '/art/items/armadura-do-foco-inabalável.png'
      | '/art/items/cota-da-rotina.png'
      | '/art/items/elmo-do-planejador-visionário.png'
      | '/art/items/espada-da-eficiencia.png'
      | '/art/items/guarda-peito-da-perseverança.png'
      | '/art/items/lamina-da-otimização.png'
