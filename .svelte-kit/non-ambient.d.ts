...
declare module '$app/types' {
  export interface AppTypes {
    ...
    Asset():
      ...
      | '/art/items/amuleto-do-cambista.png'
      | '/art/items/amuleto-do-tesouro-vivo.png'
      | '/art/items/amuleto-do-trocado.png'
      | '/art/items/anel-da-brisa-serena.png'
      | '/art/items/anel-da-cancao-silenciosa.png'
      | '/art/items/anel-do-bosque-vivo.png'
      | '/art/items/anel-do-guardiao-ancestral.png'
      | '/art/items/armadura-do-foco-inabalavel.png'
      | '/art/items/cota-da-rotina.png'
      | '/art/items/elmo-do-planejador-visionario.png'
      | '/art/items/espada-da-eficiencia.png'
      | '/art/items/guarda-peito-da-perseveranca.png'
      | '/art/items/lamina-da-otimizacao.png'
      | '/art/items/lamina-do-tempo-dobrada.png'
      | '/art/items/mochila-do-aventureiro-sem-fundo.png'
      | '/art/items/placas-do-heroi-eterno.png'
      | '/art/items/reliquia-do-cofre-infinito.png'
      | '/art/nav-wood-bar.png'
      | '/art/pets/aberracao-1.webp'
      | '/art/pets/aberracao-2.webp'
      | '/art/pets/aberracao-3.webp'
      | '/art/pets/dragao-1.webp'
      | '/art/pets/dragao-2.webp'
      | '/art/pets/dragao-3.webp'
      | '/art/pets/lich-1.webp'
      | '/art/pets/lich-2.webp'
      | '/art/pets/lich-3.webp'
      | '/art/pets/lobo-1.webp'
      | '/art/pets/lobo-2.webp'
      | '/art/pets/lobo-3.webp'
