  ...
  constructor(e, r, i) {
    ((this.#t = e),
      ...
      (this.#i = Z(() => {
        if (((v.b = this), d)) {
          const s = this.#v;
          (j(), s.nodeType === B && s.data === ee ? this.#T() : this.#E());
        } else {
          var n = this.#g();
          try {
            this.#s = p(() => i(n));
...
`,
      ...
      throw a;
    return (
      a !== I && console.warn('Failed to hydrate: ', a),
      e.recover === !1 && me(),
      M(),
      ye(r),
      S(!1),
    ...
    O = Te(() => {
      ...
      return (
        ...
        () => {
          ...
          (L.delete(h), c !== r && c.parentNode?.removeChild(c));
        }
      );
    });
  return (P.set(g, O), g);
...
const Me = '5';
typeof window < 'u' && ((window.__svelte ??= {}).v ??= new Set()).add(Me);
export {
  Ve as a,
  He as c,
  Le as d,
