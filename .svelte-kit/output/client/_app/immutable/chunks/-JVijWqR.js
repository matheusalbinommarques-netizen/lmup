import { f as Or, a as Pr } from './BYSpO852.js';
import { V as Er, K as Kr, W as Sr } from './Cowx68EC.js';
import { c as jr, s as Cr } from './DJoSvvfp.js';
import { p as Xe, r as Ar } from './DgxGOAFj.js';
var yi =
  typeof globalThis < 'u'
    ? globalThis
    : typeof window < 'u'
    ...
    xr ||
      ...
      (function (Z, ie) {
        (function (ke, A) {
          ...
          typeof Promise > 'u' || z.Promise || (z.Promise = Promise);
          ...
          function Re(e, n) {
            (typeof n == 'function' && (n = n(ae(e))),
              (typeof Reflect > 'u' ? L : Reflect.ownKeys)(n).forEach(
                function (t) {
                  ye(e, t, n[t]);
                },
              ));
          ...
          function ye(e, n, t, r) {
            Tt(
              ...
              n,
              V(
                t && ee(t, 'get') && typeof t.get == 'function'
            ...
            return {
              from: function (n) {
                return (
                  ...
                  { extend: Re.bind(null, e.prototype) }
                );
              },
            };
          }
          ...
          function qt(e) {
            z.setImmediate ? setImmediate(e) : setTimeout(e, 0);
          }
          function le(e, n) {
            if (typeof n == 'string' && ee(e, n)) return e[n];
            if (!n) return e;
            if (typeof n != 'string') {
          ...
          function ne(e, n, t) {
            if (
              ...
              if (typeof n != 'string' && 'length' in n) {
                He(typeof t != 'string' && 'length' in t);
                ...
                u !== -1
                  ? ((o = n.substr(0, u)),
                    (a = n.substr(u + 1)) === ''
                      ? t === void 0
                        ? F(e) && !isNaN(parseInt(o))
                          ? e.splice(o, 1)
                          : delete e[o]
                        : (e[o] = t)
                      : ne(
                          (u = !(u = e[o]) || !ee(e, o) ? (e[o] = {}) : u),
                          a,
                          t,
                        ))
                  : t === void 0
                    ? F(e) && !isNaN(parseInt(n))
                      ? e.splice(n, 1)
                      : delete e[n]
                    : (e[n] = t);
              }
          ...
          function Oe(e) {
            return (
              ...
              (e = (function n(t) {
                ...
                } else if (Ft.has(t.constructor)) r = t;
                else {
                  var a,
                    u = ae(t);
                  for (a in ((r =
          ...
          var Qn = typeof Symbol < 'u' ? Symbol.iterator : '@@iterator',
            Br =
              typeof Qn == 'symbol'
                ? function (e) {
                    var n;
                    return e != null && (n = e[Qn]) && n.apply(e);
                  }
                : function () {
                    return null;
                  };
...
`)
          ...
          function Le(e, n) {
            ((this.name = 'BulkError'),
              ...
              (this.message = Mt(e, this.failures)));
          }
          (Fe(Ne)
            .from(Error)
            .extend({
            ...
            Fe(yn).from(Ne),
            Fe(Le).from(Ne));
          var Xn = oe.reduce(function (e, n) {
              return ((e[n] = n + 'Error'), e);
            }, {}),
            Fr = Ne,
            C = oe.reduce(function (e, n) {
              var t = n + 'Error';
              function r(i, o) {
                ((this.name = t),
                  i
 ...
 ` + o
                      ...
                      : typeof i == 'object' &&
                        ((this.message = ''
                          ...
                          .concat(i.message)),
                        (this.inner = i))
                    : ((this.message = Rr[n] || t), (this.inner = null)));
              }
              return (Fe(r).from(Fr), (e[n] = r), e);
            }, {});
          ((C.Syntax = SyntaxError),
            (C.Type = TypeError),
            (C.Range = RangeError));
          var Nt = nn.reduce(function (e, n) {
              return ((e[n + 'Error'] = C[n]), e);
            }, {}),
            vn = oe.reduce(function (e, n) {
              return (
                  ...
                  return (
                    r &&
                      (this.onsuccess = this.onsuccess
                        ...
                        : r),
                    i &&
                      (this.onerror = this.onerror ? Ee(i, this.onerror) : i),
                    o !== void 0 ? o : t
                  );
                };
          }
                  ...
                  ((this.onsuccess = this.onerror = null),
                    ...
                    t &&
                      (this.onsuccess = this.onsuccess
                        ...
                        : t),
                    r &&
                      (this.onerror = this.onerror ? Ee(r, this.onerror) : r));
                };
          }
          function Ur(e, n) {
            return e === M
                  ...
                  return (
                    ...
                    i &&
                      (this.onsuccess = this.onsuccess
                        ...
                        : i),
                    o &&
                      (this.onerror = this.onerror ? Ee(o, this.onerror) : o),
                    r === void 0 ? (t === void 0 ? void 0 : t) : V(r, t)
                  );
                };
          }
          function Vr(e, n) {
          ...
          ((vn.ModifyError = yn), (vn.DexieError = Ne), (vn.BulkError = Le));
          var ue =
            typeof location < 'u' &&
          ...
          var en = {},
            ...
            Ke = Ke[2],
            oe = oe && oe.then,
            Se = nn && nn.constructor,
            Jn = !!Ke,
            tn = function (e, n) {
              (rn.push([e, n]), mn && (queueMicrotask(Wr), (mn = !1)));
            },
            Zn = !0,
            mn = !0,
            je = [],
          ...
          function K(e) {
            ...
            if (typeof e != 'function') {
              if (e !== en) throw new TypeError('Not a function');
              return (
                (this._state = arguments[1]),
                (this._value = arguments[2]),
                void (this._state === !1 && tt(this, this._value))
              );
            }
            ((this._state = null),
              (this._value = null),
              ...
              function t(r, i) {
                var o = this,
                  ...
                  c = new K(function (l, p) {
                    rt(o, new Vt(Yt(r, e, a, u), Yt(i, e, a, u), l, p, e));
                  });
                return (
          ...
          function zt(e) {
            var n = e._listeners;
            e._listeners = [];
            for (var t = 0, r = n.length; t < r; ++t) rt(e, n[t]);
            var i = e._PSD;
            (--i.ref || i.finalize(),
              Ce === 0 &&
                (++Ce,
                ...
                n._state ||
                  ...
                  (function (o) {
                    for (var a = je.length; a; )
                      if (je[--a]._value === o._value) return je.splice(a, 1);
                  })(n),
                t.resolve(r));
            } catch (o) {
              t.reject(o);
            } finally {
              (--Ce == 0 && it(), --t.psd.ref || t.psd.finalize());
            }
          }
          function Wr() {
            Ae(ve, function () {
          ...
          function Ve() {
            ...
            do
              for (; 0 < rn.length; )
                for (e = rn, rn = [], t = e.length, n = 0; n < t; ++n) {
                  var r = e[n];
                  r[0].apply(null, r[1]);
                }
            while (0 < rn.length);
          ...
          function it() {
            ...
            for (var n = bn.slice(0), t = n.length; t; ) n[--t]();
          }
          function wn(e) {
            return new K(en, !1, e);
          }
          ...
          (Re(K.prototype, {
            then: nt,
            _then: function (e, n) {
              rt(this, new Vt(null, null, e, n, j));
            },
            catch: function (e) {
              ...
              return typeof n == 'function'
                ? this.then(null, function (r) {
                    return (r instanceof n ? t : wn)(r);
                  })
                : this.then(null, function (r) {
                    return (r && r.name === n ? t : wn)(r);
                  });
            },
            finally: function (e) {
              return this.then(
            ...
            typeof Symbol < 'u' &&
              Symbol.toStringTag &&
              ye(K.prototype, Symbol.toStringTag, 'Dexie.Promise'),
            (ve.env = Wt()),
            Re(K, {
              all: function () {
          ...
          function ze() {
            return ($.id || ($.id = ++Yr), ++$.awaits, ($.echoes += Ut), $.id);
          }
          function ge() {
            return (
              !!$.awaits &&
              (--$.awaits == 0 && ($.id = 0), ($.echoes = $.awaits * Ut), !0)
            );
          }
          function On(e) {
            return $.echoes && e && e.constructor === Se
              ? (ze(),
                e.then(
                  function (n) {
                    return (ge(), n);
            ...
            ((n ? !$.echoes || (xn++ && e === j) : !xn || (--xn && e === j)) ||
              ...
              e !== j &&
                ...
                Jn &&
                  ...
                  (n = e.env),
                  (r.global || e.global) &&
                    (Object.defineProperty(z, 'Promise', n.PromiseProp),
                    (t.all = n.all),
                    (t.race = n.race),
                    (t.resolve = n.resolve),
                    (t.reject = n.reject),
          ...
          function Wt() {
            ...
            return Jn
              ? {
                  Promise: e,
                  PromiseProp: Object.getOwnPropertyDescriptor(z, 'Promise'),
                  all: e.all,
                  race: e.race,
          ...
          ('' + oe).indexOf('[native code]') === -1 && (ze = ge = M);
          var W = K.reject,
            De = '￿',
            he =
          ...
          function En(e) {
            return typeof e != 'string' || /\./.test(e)
              ...
              : function (n) {
                  return (
                    n[e] === void 0 && e in n && delete (n = Oe(n))[e],
                    n
                  );
                };
          }
                ...
                Promise.all(
                  r.map(function (i) {
                    return (
                      (i = i.updatesTable),
                      n
                        ? e.db.table(i).where('k').anyOf(n).delete()
                        : e.db.table(i).clear()
                    );
                  }),
                ).then(function () {
          ...
          var on =
            ((Jt.prototype.execute = function (e) {
              ...
              if (n.add !== void 0) {
                var t = n.add;
                if (F(t)) return pe(pe([], F(e) ? e : [], !0), t).sort();
              ...
              return (
                (t =
                  (t = n.replacePrefix) === null || t === void 0
                    ? void 0
                    : t[0]),
                t && typeof e == 'string' && e.startsWith(t)
                  ? n.replacePrefix[1] + e.substring(t.length)
                  : e
              );
            }),
            Jt);
          ...
          function Zt(e, n) {
            for (var t = L(n), r = t.length, i = !1, o = 0; o < r; ++o) {
              var a = t[o],
                u = n[a],
                c = le(e, a);
              u instanceof on
                ? (ne(e, a, u.execute(c)), (i = !0))
                : c !== u && (ne(e, a, u), (i = !0));
            }
            return i;
          }
          var er =
                  ...
                  r && r.db._novip === this.db._novip
                    ...
                    : (function l(p, s, v, f) {
                        ...
                        if (p._state.openComplete)
                          return W(new C.DatabaseClosed(p._state.dbOpenError));
                        if (!p._state.isBeingOpened) {
                          if (!p._state.autoOpen)
                            return W(new C.DatabaseClosed());
                          p.open().catch(M);
                        }
            ...
            (N.prototype.get = function (e, n) {
              ...
              return e && e.constructor === Object
                ...
                : e == null
                  ? W(new C.Type('Invalid argument to Table.get()'))
            ...
            (N.prototype.mapToClass = function (e) {
              ...
              (this.schema.mappedClass = e).prototype instanceof Gt &&
                ((function (c, l) {
                ...
                (e = i));
              for (var o = new Set(), a = e.prototype; a; a = ae(a))
            ...
            (N.prototype.upsert = function (e, n) {
              var t = this,
            ...
            (N.prototype.update = function (e, n) {
              return typeof e != 'object' || F(e)
                ? this.where(':id').equals(e).modify(n)
                : ((e = le(e, this.schema.primKey.keyPath)),
                  e === void 0
                    ? W(
                        new C.InvalidArgument(
            ...
            (N.prototype.delete = function (e) {
              ...
              return this._trans('readwrite', function (t) {
                return n.core
                  .mutate({ trans: t, type: 'delete', keys: [e] })
                  .then(function (r) {
                    return Kn(n, [e], r);
                  })
                  .then(function (r) {
            ...
            (N.prototype.clear = function () {
              ...
              return this._trans('readwrite', function (n) {
                return e.core
                  .mutate({ trans: n, type: 'deleteRange', range: Qt })
                  .then(function (t) {
                    return Kn(e, null, t);
                  });
              }).then(function (n) {
          ...
          function un(e, n) {
            return (Fe(n).from({ prototype: e }), n);
          }
          function Ye(e, n) {
            return (
          ...
          function jn(e, n, t, r) {
            var i = e.replayFilter ? Te(e.filter, e.replayFilter()) : e.filter;
            if (e.or) {
              var o = {},
                a = function (u, c, l) {
                  var p, s;
                  (i &&
                    ...
                    ((s = '' + (p = c.primaryKey)) == '[object ArrayBuffer]' &&
                      (s = '' + new Uint8Array(p)),
                    ee(o, s) || ((o[s] = !0), n(u, c, l)));
                };
              return Promise.all([
                e.or._iterate(a, t),
                tr(nr(e, r, t), e.algorithm, a, !e.keysOnly && e.valueMapper),
              ]);
            }
            return tr(
              nr(e, r, t),
          ...
          var Gr =
              ...
              return this._read(function (t) {
                ...
                if (Ye(r, !0))
                  return i
                    .count({
                      trans: t,
                      query: { index: Sn(r, i.schema), range: r.range },
                    })
                    .then(function (a) {
            ...
            (R.prototype.filter = function (e) {
              var n;
              return (
                st(this._ctx, function (t) {
                  return e(t.value);
                }),
                ((n = this._ctx).isMatch = Te(n.isMatch, e)),
                this
              );
            }),
            ...
            (R.prototype.primaryKeys = function (e) {
              var n = this._ctx;
              if (n.dir === 'next' && Ye(n, !0) && 0 < n.limit)
                return this._read(function (r) {
                  var i = Sn(n, n.table.core.schema);
            ...
            (R.prototype.modify = function (e) {
              ...
              return this._write(function (r) {
                var i =
                  ...
                  u = l.extractKey,
                  c = 200,
                  l = n.db._options.modifyChunkSize;
                l &&
                ...
                function p(d, g) {
                  var m = g.failures,
                    g = g.numFailures;
                  v += d - g;
                  for (var b = 0, w = L(m); b < w.length; b++) {
                    var x = w[b];
                    s.push(m[x]);
                  }
                }
                ...
                return n
                  ...
                  .then(function (d) {
                    function y(g) {
                      var b = Math.min(c, d.length - g),
                        w = d.slice(g, g + b);
                      return (
                        h
                          ? Promise.resolve([])
                          : o.getMany({ trans: r, keys: w, cache: 'immutable' })
                      ).then(function (x) {
                        var P = [],
                          _ = [],
                          k = a ? [] : null,
                        ...
                        if (!h)
                          for (var O = 0; O < b; ++O) {
                            var S = x[O],
                              T = { value: Oe(S), primKey: d[g + O] };
                            i.call(T, T.value, T) !== !1 &&
                              (T.value == null
                                ? E.push(d[g + O])
                                : a || B(u(S), u(T.value)) === 0
                                  ? (_.push(T.value), a && k.push(d[g + O]))
                                  : (E.push(d[g + O]), P.push(T.value)));
                          }
                            ...
                            o
                              ...
                              .then(function (I) {
                                for (var q in I.failures)
                                  E.splice(parseInt(q), 1);
                                p(P.length, I);
                              }),
                        )
                          .then(function () {
                            return (
                              (0 < _.length || (m && typeof e == 'object')) &&
                              o
                                .mutate({
                                  trans: r,
                                  type: 'put',
          ...
          function te(e, n, t) {
            return (
              (e = e instanceof or ? new e.Collection(e) : e),
              ...
              e._addAlgorithm(function (h, d, y) {
                ...
                for (var b = null, w = f; w < s; ++w) {
                  var x = (function (P, _, k, E, O, S) {
                    for (
                      var T = Math.min(P.length, E.length), I = -1, q = 0;
                      q < T;
                      ++q
                    ) {
                      var re = _[q];
                      if (re !== E[q])
                        return O(P[q], k[q]) < 0
                          ? P.substr(0, q) + k[q] + k.substr(q + 1)
                          : O(P[q], E[q]) < 0
                            ? P.substr(0, q) + E[q] + k.substr(q + 1)
                            : 0 <= I
                              ? P.substr(0, I) + _[I] + k.substr(I + 1)
                              : null;
                      O(P[q], re) < 0 && (I = q);
                    }
                    return T < E.length && S === 'next'
                      ? P + k.substr(P.length)
                      : T < P.length && S === 'prev'
                        ? P.substr(0, k.length)
                        : I < 0
                          ? null
                          : P.substr(0, I) + E[I] + k.substr(I + 1);
                  })(m, g, u[w], c[w], a, l);
                  x === null && b === null
                    ? (f = w + 1)
                    : (b === null || 0 < a(b, x)) && (b = x);
          ...
          var or =
            ...
            (Q.prototype.between = function (e, n, t, r) {
              ((t = t !== !1), (r = r === !0));
              try {
            ...
            (Q.prototype.inAnyRange = function (m, n) {
              var t = this,
                r = this._cmp,
                i = this._ascending,
                o = this._descending,
              ...
              var f = 0,
                ...
                m = new this.Collection(this, function () {
                  return we(p[0][0], p[p.length - 1][1], !c, !l);
                });
              return (
                ...
                m._addAlgorithm(function (g, b, w) {
                  for (var x, P = g.key; y(P); )
                    if (++f === p.length) return (b(w), !1);
                  return (
                    (!h((x = P)) && !d(x)) ||
                    (t._cmp(P, p[f][1]) === 0 ||
                      t._cmp(P, p[f][0]) === 0 ||
          ...
          function se(e) {
            return U(function (n) {
              return (sn(n), e(n.target.error), !1);
            });
          }
          function sn(e) {
          ...
          var cn = 'storagemutated',
            ...
            Jr =
              ...
              (ce.prototype._unlock = function () {
                if ((He(!j.global), --this._reculock == 0))
                  for (
              ...
              (ce.prototype.create = function (e) {
                ...
                return (
                  ...
                  ((e = this.idbtrans =
                    ...
                    )).onerror = U(function (i) {
                    (sn(i), n._reject(e.error));
                  })),
                  (e.onabort = U(function (i) {
                    (sn(i),
                      n.active && n._reject(new C.Abort(e.error)),
                      (n.active = !1),
                      n.on('abort').fire(i));
                  })),
              ...
              (ce.prototype._promise = function (e, n, t) {
                var r = this;
                if (e === 'readwrite' && this.mode !== 'readwrite')
                  return W(new C.ReadOnly('Transaction is readonly'));
                if (!this.active) return W(new C.TransactionInactive());
                if (this._locked())
              ...
              (ce.prototype.waitFor = function (e) {
                ...
                return new K(function (o, a) {
                  r.then(
                    function (u) {
                      return t._waitingQueue.push(U(o.bind(null, u)));
                    },
                    function (u) {
                      return t._waitingQueue.push(U(a.bind(null, u)));
                    },
                  ).finally(function () {
              ...
              return {
                ...
                mutate: function (d) {
                  ...
                  return new Promise(function (x, P) {
                    ...
                    if (m === 'deleteRange') {
                      ...
                      w.type === 3
                        ? I.push((O = _.clear()))
                        : I.push((O = _.delete(r(w))));
                    } else {
                      var k = E ? (k ? [b, g] : [b, null]) : [g, null],
                        D = k[0],
                        X = k[1];
                      if (E)
                        for (var H = 0; H < S; ++H)
                        ...
                        for (H = 0; H < S; ++H)
                          (I.push((O = _[m](D[H]))), (O.onerror = T));
                    }
                    function Un(J) {
                      ((J = J.target.result),
                        I.forEach(function (Be, At) {
                          return Be.error != null && (q[At] = Be.error);
                        }),
                        x({
                          numFailures: re,
                          failures: q,
                  ...
                  function (d) {
                    return new Promise(function (y, m) {
                      ...
                      var g,
                        ...
                        O = O.range,
                        k = k.objectStore(h),
                        E = E.isPrimaryKey ? k : k.index(E.name),
                        O = r(O);
                      if (P === 0) return y({ result: [] });
                      f
                        ? (((_ = x
                            ? E.getAll(O, _)
                            : E.getAllKeys(O, _)).onsuccess = function (S) {
                            return y({ result: S.target.result });
                          }),
                          (_.onerror = se(m)))
                        : ((g = 0),
                          (b =
                            !x && 'openKeyCursor' in E
                              ? E.openKeyCursor(O)
                              : E.openCursor(O)),
                          (w = []),
                ...
                openCursor: function (d) {
                  ...
                  return new Promise(function (x, P) {
                    ...
                    var E = g.index,
                      _ = g.range,
                      k = y.objectStore(h),
                      k = E.isPrimaryKey ? k : k.index(E.name),
                      E = b
                        ? w
                          ? 'prevunique'
                          : 'prev'
                      ...
                      O =
                        !m && 'openKeyCursor' in k
                          ? k.openKeyCursor(r(_), E)
                          : k.openCursor(r(_), E);
                    ((O.onerror = se(P)),
                      (O.onsuccess = U(function (S) {
                        var T,
                          I,
                          q,
                          re,
                        ...
                        D
                          ? ((D.___id = ++Zr),
                            (D.done = !1),
                            (T = D.continue.bind(D)),
                            (I = (I = D.continuePrimaryKey) && I.bind(D)),
                            (q = D.advance.bind(D)),
                            (re = function () {
                            ...
                            (D.start = function (X) {
                              ...
                              var Un = new Promise(function (J, Be) {
                                ((J = U(J)),
                                  (O.onerror = se(Be)),
                                  (D.fail = Be),
                                  (D.stop = function (At) {
                              ...
                              return (
                                (O.onsuccess = U(function (J) {
                                  ((O.onsuccess = H), H());
                                })),
                                (D.continue = T),
                                (D.continuePrimaryKey = I),
                                (D.advance = q),
                                H(),
                                Un
                              );
                ...
                count: function (d) {
                  ...
                  return new Promise(function (w, x) {
                    var P = m.objectStore(h),
                      _ = g.isPrimaryKey ? P : P.index(g.name),
                      P = r(b),
                      _ = P ? _.count(P) : _.count();
                    ((_.onsuccess = U(function (k) {
          ...
          function An(e, r) {
            var t = r.db,
              r = ni(e._middlewares, t, e._deps, r);
            ((e.core = r.dbcore),
              ...
              return (
                ...
                n !== 0
                            ...
                            ? (p.forEach(function (m) {
                                (d.push(function () {
                                  ...
                                  (w.add.forEach(function (E) {
                                    vt(h, E[0], E[1].primKey, E[1].indexes);
                                  }),
                                  ...
                                  if (x && m._cfg.version > v) {
                                    (An(s, h), (f._memoizedTables = {}));
                                    var P = Bt(b);
                                    (w.del.forEach(function (E) {
                                      P[E] = g[E];
                                    }),
                                      pt(s, [s.Transaction.prototype]),
                                      Dn(s, [s.Transaction.prototype], L(P), P),
                                      (f.schema = P));
                                    var _,
                                      k = Gn(x);
                                    return (
                              ...
                              (function m() {
                                return d.length
                                  ? K.resolve(d.shift()(f.idbtrans)).then(m)
                                  : K.resolve();
                              })().then(function () {
                                sr(y, h);
                              }))
                  ...
                  : (L(i).forEach(function (p) {
                      vt(t, p, i[p].primKey, i[p].indexes);
                    }),
                    An(e, t),
          ...
          function ii(e, n) {
            ...
            var t = In(0, e.idbdb, n);
            qn(e, e._dbSchema, n);
            for (var r = 0, i = yt(t, e._dbSchema).change; r < i.length; r++) {
              var o = (function (a) {
          ...
          function sr(e, n) {
            L(e).forEach(function (t) {
              n.db.objectStoreNames.contains(t) ||
                (ue && console.debug('Dexie: Creating missing table', t),
                vt(n, t, e[t].primKey, e[t].indexes));
            });
          }
          function Tn(e, n) {
          ...
          function In(e, n, t) {
            var r = {};
            return (
              pn(n.objectStoreNames, 0).forEach(function (i) {
                for (
          ...
          function qn(e, n, t) {
            ...
            typeof navigator < 'u' &&
              ...
              !/(Chrome\/|Edge\/)/.test(navigator.userAgent) &&
              z.WorkerGlobalScope &&
              z instanceof z.WorkerGlobalScope &&
          ...
          var oi =
            ((Qe.prototype._createTableSchema = ht),
            (Qe.prototype._parseIndexSyntax = cr),
            (Qe.prototype._parseStoresSpec = function (e, n) {
              var t = this;
              L(e).forEach(function (r) {
                if (e[r] !== null) {
                  var i = t._parseIndexSyntax(e[r]),
                    o = i.shift();
                  if (!o)
                    throw new C.Schema(
                  ...
                  if (((o.unique = !0), o.multi))
                    throw new C.Schema('Primary key cannot be multiEntry*');
                  (i.forEach(function (a) {
                    ...
                    (i = t._createTableSchema(r, o, i)),
                    (n[r] = i));
                }
              });
            }),
            (Qe.prototype.stores = function (t) {
              var n = this.db;
              this._cfg.storesSource = this._cfg.storesSource
                ? V(this._cfg.storesSource, t)
                : t;
              var t = n._versions,
                r = {},
                i = {};
              return (
                t.forEach(function (o) {
                  (V(r, o._cfg.storesSource),
                    (i = o._cfg.dbschema = {}),
                    o._parseStoresSpec(r, i));
                }),
                (n._dbSchema = i),
                pt(n, [n._allTables, n, n.Transaction.prototype]),
                Dn(
                  n,
          ...
          function mt(e, n) {
            ...
            return (
              t ||
                (t = e._dbNamesDB =
                  new de(Pn, { addons: [], indexedDB: e, IDBKeyRange: n }))
                  .version(1)
                  .stores({ dbnames: 'name' }),
              t.table('dbnames')
            );
          ...
          function hn(e, n, t) {
            ...
            if (!isNaN(r)) {
              ...
              if (wt(e)) return V(e, { from: n, to: t, d: 1 });
              var i = e.l,
                r = e.r;
              if (B(t, e.from) < 0)
                return (
          ...
          function lr(e, n) {
            ...
            if (r.done) return !1;
            for (
              var i = r.value, o = Bn(e), a = o.next(i.from), u = a.value;
              !r.done && !a.done;
          ...
          function Ot(e, n) {
            ...
            var t = new Set();
            if (e.all)
              for (var r = 0, i = Object.values(Ie); r < i.length; r++)
                dr((a = i[r]), e, t, n);
            else
              for (var o in e) {
                var a,
          ...
          function ai(e) {
            ...
            if (n.isBeingOpened || e.idbdb)
              return n.dbReadyPromise.then(function () {
                return n.dbOpenError ? W(n.dbOpenError) : e;
              });
            ((n.isBeingOpened = !0),
              (n.dbOpenError = null),
              (n.openComplete = !1));
            ...
            function u() {
              return new K(function (v, f) {
                ...
                var h = e.name,
                  d = n.autoSchema || !i ? t.open(h) : t.open(h, i);
                if (!d) throw new C.MissingAPI();
                ((d.onerror = se(f)),
                  (d.onblocked = U(e._fireOnBlocked)),
                  (d.onupgradeneeded = U(function (y) {
                    var m;
                    ((p = d.transaction),
                      n.autoSchema && !e._options.allowEmptyDB
                        ? ((d.onerror = sn),
                          p.abort(),
                          d.result.close(),
                          ((m = t.deleteDatabase(h)).onsuccess = m.onerror =
                            U(function () {
                              f(
                                new C.NoSuchDatabase(
                  ...
                  (d.onsuccess = U(function () {
                      ...
                      try {
                        ...
                        if (n.autoSchema)
                          ((m = x),
                            ...
                            (g = y._dbSchema = In(0, m, g)),
                            (y._storeNames = pn(m.objectStoreNames, 0)),
                            Dn(y, [y._allTables], L(g), g));
                        else if (
                          (qn(e, e._dbSchema, _),
                          ((w = yt(In(0, (w = e).idbdb, _), w._dbSchema)).add
                            .length ||
                    ...
                    (We.push(e),
                      (x.onversionchange = U(function (k) {
                        ((n.vcFired = !0), e.on('versionchange').fire(k));
                      })),
                      (x.onclose = U(function () {
            ...
            return K.race([
                ...
                return (
                  ...
                  K.resolve(
                    ...
                    if (0 < n.onReadyBeingFired.length) {
                      var f = n.onReadyBeingFired.reduce(Hn, M);
                      return (
                        (n.onReadyBeingFired = []),
                        K.resolve(
                          bt(function () {
              ...
              .catch(function (v) {
                ...
                return (r === n.openCanceller && e._close(), W(v));
              })
              .finally(function () {
                ((n.openComplete = !0), l());
              })
          ...
          function Mn(e, n, t) {
            for (var r = F(e) ? e.slice() : [e], i = 0; i < t; ++i) r.push(n);
            return r;
          }
          var ui = {
            stack: 'dbcore',
                        ...
                        return Object.create(m, {
                          continue: {
                            value: function (g) {
                              g != null
                                ? m.continue(
                                    Mn(g, s.reverse ? e.MAX_KEY : e.MIN_KEY, f),
                                  )
                                : s.unique
                                  ? m.continue(
                                      m.key
                          ...
                          continuePrimaryKey: {
                            value: function (g, b) {
                              m.continuePrimaryKey(Mn(g, e.MAX_KEY, f), b);
                            },
                          },
                          primaryKey: {
                            get: function () {
                        ...
                        return (
                          (s =
                            s.type === 'add' || s.type === 'put'
                              ? A(A({}, s), { keys: y })
                              : A({}, s)).type !== 'delete' &&
                            (s.values = pe([], s.values)),
                          s.keys && (s.keys = pe([], s.keys)),
                          (v = t),
                          (h = y),
                          ((f = s).type === 'add'
                            ? Promise.resolve([])
                            ...
                            var g = y.map(function (b, w) {
                              var x,
                                ...
                                _,
                                k = m[w],
                                E = { onerror: null, onsuccess: null };
                              return (
                                s.type === 'delete'
                                  ? u.fire.call(E, b, k, d)
                                  : s.type === 'add' || k === void 0
                                    ? ((x = c.fire.call(E, b, s.values[w], d)),
                                      b == null &&
                                        x != null &&
                                        ((s.keys[w] = b = x),
                                        r.outbound ||
                                          ne(s.values[w], r.keyPath, b)))
                                    : ((x = Et(k, s.values[w])),
                                      (P = l.fire.call(E, x, b, k, d)) &&
                                        ((_ = s.values[w]),
          ...
          function pr(e, n, t) {
            try {
              ...
              for (
                ...
                B(n.keys[i], e[o]) === 0 &&
                  (r.push(t ? Oe(n.values[i]) : n.values[i]), ++o);
              ...
              return A(A({}, e), {
                ...
                table: function (r) {
                  var i = e.table(r),
                    ...
                    p = A(A({}, i), {
                      mutate: function (f) {
                        ...
                        var d,
                          ...
                          m,
                          g = f.trans,
                          b = f.mutatedParts || (f.mutatedParts = {}),
                          w = h(''),
                          x = h(':dels'),
                          P = f.type,
                          E =
                        ...
                        return (
                            ...
                            ? (w.addKeys(_),
                              ...
                              (E || k) &&
                                ...
                                o.indexes.forEach(function (O) {
                                  var S = d(O.name || '');
                                  function T(q) {
                                    return q != null ? O.extractKey(q) : null;
                                  }
                                  function I(q) {
                                    return O.multiEntry && F(q)
                                      ? q.forEach(function (re) {
                                          return S.addKey(re);
                                        })
                                      : S.addKey(q);
                                  }
                                  (y || m).forEach(function (q, X) {
                                    var D = y && T(y[X]),
                                      X = m && T(m[X]);
                                    B(D, X) !== 0 &&
                                      (D != null && I(D), X != null && I(X));
                                  });
                                })))
                            : _
                              ? ((k = {
                                  from:
                                    (k = _.lower) !== null && k !== void 0
                                      ? k
                                      : e.MIN_KEY,
                                  to:
                                    (k = _.upper) !== null && k !== void 0
                                      ? k
                                      : e.MAX_KEY,
                                }),
                                x.add(k),
                          ...
                          i.mutate(f).then(function (O) {
                            return (
                              !_ ||
                                ...
                                l &&
                                  l.forEach(function (S) {
                                    for (
                                      var T = f.values.map(function (D) {
                                          return S.extractKey(D);
                                        }),
                                        I = S.keyPath.findIndex(function (D) {
                                          return D === a.keyPath;
                                        }),
                                        q = 0,
                                        re = O.results.length;
                              ...
                              (g.mutatedParts = Rn(g.mutatedParts || {}, b)),
                              O
                            );
                          })
                        );
                    ...
                    v = {
                      get: function (f) {
                        return [a, new G(f.key)];
                      },
                      getMany: function (f) {
                        return [a, new G().addKeys(f.keys)];
                      },
                      count: s,
                      query: s,
                      openCursor: s,
            ...
            var a = n.query.index,
              ...
              v = v.reduce(function (f, h) {
                ...
                if (h.type === 'add' || h.type === 'put')
                  for (var m = new G(), g = h.values.length - 1; 0 <= g; --g) {
                    var b,
                      w = h.values[g],
                      x = l(w);
                    m.hasKey(x) ||
              ...
              return A(A({}, e), {
                      ...
                      (i = function (c) {
                        return function () {
                          if ((o.abort(), r === 'readwrite')) {
                            for (
                              var l = new Set(), p = 0, s = t;
                              p < s.length;
                              p++
                            ) {
                              var v = s[p],
                                f = Ie['idb://'.concat(n, '/').concat(v)];
                              if (f) {
                                var h = e.table(v),
                                  d = f.optimisticOps.filter(function (S) {
                                    return S.trans === u;
                                  });
                                if (u._explicit && c && u.mutatedParts)
                                  for (
                                    ...
                                    for (
                                      var g = 0, b = (P = m[y]).slice();
                                      g < b.length;
                                      g++
                                    )
                                      _t((_ = b[g]).obsSet, u.mutatedParts) &&
                                        (Pe(P, _),
                                        _.subscribers.forEach(function (S) {
                                          return l.add(S);
                                        }));
                                else if (0 < d.length) {
                                  ...
                                  for (
                                    ...
                                    for (
                                      ...
                                      (_ = O[E]).res != null &&
                                        u.mutatedParts &&
                                        (c && !_.dirty
                                          ? ((k = Object.isFrozen(_.res)),
                                            (k = gr(_.res, _.req, d, h, _, k)),
                                            _.dirty
                                              ? (Pe(P, _),
                ...
                table: function (t) {
                  ...
                  return A(A({}, r), {
                        ...
                        ? ((a = r.mutate(o)),
                          ...
                          !(
                            ...
                            ? (u.optimisticOps.push(o),
                              o.mutatedParts && Fn(o.mutatedParts),
                              a.then(function (c) {
                                0 < c.numFailures &&
                                  (Pe(u.optimisticOps, o),
                                  (c = mr(0, o, c)) && u.optimisticOps.push(c),
                                  o.mutatedParts && Fn(o.mutatedParts));
                              }),
                              a.catch(function () {
                                (Pe(u.optimisticOps, o),
                            ...
                            : a.then(function (c) {
                                ...
                                (u.optimisticOps.push(l),
                                  queueMicrotask(function () {
                                    return o.mutatedParts && Fn(o.mutatedParts);
                                  }));
                              }),
                          a)
                        : r.mutate(o);
                    ...
                    query: function (o) {
                      if (!yr(j, r) || !vr('query', o)) return r.query(o);
                      var a =
                        ...
                        l = (function (h, d, y, m) {
                          ...
                          if (!g) return [];
                          if (!(d = g.queries[y])) return [null, !1, g, null];
                          var b =
                          ...
                          switch (y) {
                            case 'query':
                              var w = b.find(function (x) {
                                return (
                                  ...
                                  br(x.req.query.range, m.query.range)
                                );
                              });
                              return w
                                ? [w, !0, g, b]
                                : [
                                    b.find(function (x) {
                                      return (
                                        ...
                                        fi(x.req.query.range, m.query.range)
                                      );
                                    }),
                                    !1,
                                    g,
                            ...
                            case 'count':
                              return (
                                (w = b.find(function (x) {
                                  return br(x.req.query.range, m.query.range);
                                })),
                                [w, !!w, g, b]
                              );
                          }
                      ...
                      return (
                        p && s
                          ...
                          : ((s = r
                              ...
                              .catch(function (h) {
                                return (f && p && Pe(f, p), Promise.reject(h));
                              })),
                            (p = {
                              obsSet: o.obsSet,
                              promise: s,
                        ...
                        p.promise.then(function (h) {
                          return {
                            result: gr(h.result, o, v?.optimisticOps, r, p, a),
                          };
                        })
                      );
                    },
          ...
          var de =
              ...
              return this.idbdb &&
                ...
                : new K(function (t, r) {
                    if (n._state.openComplete)
                      return r(new C.DatabaseClosed(n._state.dbOpenError));
            ...
            (Y.prototype._close = function () {
              ...
              var e = this._state,
                n = We.indexOf(this);
              if ((0 <= n && We.splice(n, 1), this.idbdb)) {
                try {
                  this.idbdb.close();
                } catch {}
                this.idbdb = null;
              ...
              e.isBeingOpened ||
                ((e.dbReadyPromise = new K(function (t) {
                  e.dbReadyResolve = t;
                })),
            ...
            (Y.prototype.close = function (t) {
              var n = (t === void 0 ? { disableAutoOpen: !0 } : t)
                ...
                t = this._state;
              n
                ? (t.isBeingOpened && t.cancelOpen(new C.DatabaseClosed()),
                  this._close(),
                  (t.autoOpen = !1),
                  (t.dbOpenError = new C.DatabaseClosed()))
                : (this._close(),
                ...
                function a() {
                  ...
                  ((u.onsuccess = U(function () {
                    ...
                    ((c = n._deps),
                      ...
                      (p = c.indexedDB),
                      (c = c.IDBKeyRange),
                      gt(p) || l === Pn || mt(p, c).delete(l).catch(M),
                      i());
                  })),
                    (u.onerror = se(o)),
            ...
            (Y.prototype.transaction = function () {
              var e = function (n, t, r) {
                ...
                return ((r = o.pop()), [n, Rt(o), r]);
              }.apply(this, arguments);
              return this._transaction.apply(this, e);
            }),
            (Y.prototype._transaction = function (e, n, t) {
              var r = this,
                i = j.trans;
                ...
                return K.resolve().then(function () {
                  ...
                  return (
                    ...
                    (m && typeof m.then == 'function'
                      ? K.resolve(m).then(function (b) {
                          return y.active
                            ? b
                            : W(
                                new C.PrematureCommit(
              ...
              return i
                ? i._promise(o, c, 'lock')
                : j.trans
                  ? Ae(j.transless, function () {
                      return r._whenReady(c);
                    })
                  : this._whenReady(c);
            }),
            (Y.prototype.table = function (e) {
              if (!ee(this._allTables, e))
                throw new C.InvalidTable('Table '.concat(e, ' does not exist'));
          ...
          function Y(e, n) {
            ...
            ((l.dbReadyPromise = new K(function (s) {
                  ...
                  return function (v, f) {
                    Y.vip(function () {
                      var h,
                        d = t._state;
                      d.openComplete
                        ? (d.dbOpenError || K.resolve().then(v), f && s(v))
                        : d.onReadyBeingFired
              ...
              (this.Collection =
                ...
                un(Gr.prototype, function (m, y) {
                  ...
                  this._ctx = {
                    ...
                    error: h,
                    or: d.or,
                    valueMapper: m !== Ze ? m : null,
                  };
                }))),
              (this.Table =
                ((o = this),
                un(er.prototype, function (s, v, f) {
                  ((this.db = o),
                    (this._tx = f),
                    (this.name = s),
                    (this.schema = v),
              ...
              (this.Transaction =
                ((a = this),
                un(Jr.prototype, function (s, v, f, h, d) {
                  var y = this;
                  (s !== 'readonly' &&
                    ...
                    (this.idbtrans = null),
                    (this.on = an(this, 'complete', 'error', 'abort')),
                    (this.parent = d || null),
                    (this.active = !0),
                    (this._reculock = 0),
                    (this._blockedFuncs = []),
                    ...
                    (this._spinCount = 0),
                    (this._completion = new K(function (m, g) {
              ...
              (this.WhereClause =
                ((c = this),
                un(or.prototype, function (s, v, f) {
                  if (
                    ((this.db = c),
                    (this._ctx = {
                      table: s,
            ...
            var p = new Proxy(this, {
              get: function (s, v, f) {
                ...
                if (v === 'table')
                  return function (d) {
                    return Nn(t.table(d), p);
                  };
                var h = Reflect.get(s, v, f);
                return h instanceof er
                  ? Nn(h, p)
                  : v === 'tables'
                    ? h.map(function (d) {
                        return Nn(d, p);
                    ...
                    : v === '_createTransaction'
                      ? function () {
                          return Nn(h.apply(this, arguments), p);
                        }
                      : h;
              },
            });
          ...
          var Ln,
            oe =
              typeof Symbol < 'u' && 'observable' in Symbol
                ...
                : '@@observable',
            pi =
              ((jt.prototype.subscribe = function (e, n, t) {
          ...
          try {
            Ln = {
              indexedDB:
                ...
                z.webkitIndexedDB ||
                z.msIndexedDB,
              IDBKeyRange: z.IDBKeyRange || z.webkitIDBKeyRange,
            };
          } catch {
                  ...
                  p = {
                    ...
                    unsubscribe: function () {
                      u ||
                        ((u = !0),
                        a && a.abort(),
                        s && _e.storagemutated.unsubscribe(f));
                    },
                  };
                i.start && i.start(p);
                var s = !1,
                        ...
                        function (g) {
                          ((t = !0),
                            ...
                            u ||
                              ...
                              ((c = {}),
                              (function (b) {
                                for (var w in b) if (ee(b, w)) return;
                                return 1;
                              })((l = d)) ||
                                s ||
                                (_e(cn, f), (s = !0)),
          ...
          function Ct(e) {
            var n = xe;
            try {
              ((xe = !0), _e.storagemutated.fire(e), Ot(e, !0));
            } finally {
              xe = n;
            }
          }
          (Re(
            ...
            A(A({}, vn), {
                ...
                try {
                  return (
                    ...
                    (gt(t)
                      ...
                      : mt(t, n).toCollection().primaryKeys()
                    ).then(e)
                  );
                } catch {
                  return W(new C.MissingAPI());
                }
                var n, t;
              },
              ...
              ignoreTransaction: function (e) {
                return j.trans ? Ae(j.transless, e) : e();
              },
              vip: bt,
              async: function (e) {
                return function () {
                  try {
                    var n = Pt(e.apply(this, arguments));
            ...
            (qe.maxKey = ln(qe.dependencies.IDBKeyRange)),
            typeof dispatchEvent < 'u' &&
              typeof addEventListener < 'u' &&
              (_e(cn, function (e) {
                xe ||
                  ((e = new CustomEvent(lt, { detail: e })),
                  (xe = !0),
                  dispatchEvent(e),
                  (xe = !1));
              }),
          ...
          return (
            typeof BroadcastChannel < 'u' &&
              ((_r = function () {
                (Ge = new BroadcastChannel(lt)).onmessage = function (e) {
                  return e.data && Ct(e.data);
                };
              })(),
              typeof Ge.unref == 'function' && Ge.unref(),
              _e(cn, function (e) {
                xe || Ge.postMessage(e);
              })),
            typeof addEventListener < 'u' &&
              (addEventListener('pagehide', function (e) {
                if (!de.disableBfCache && e.persisted) {
                  (ue && console.debug('Dexie: handling persisted pagehide'),
                    Ge?.close());
                  for (var n = 0, t = We; n < t.length; n++)
              ...
              addEventListener('pageshow', function (e) {
                !de.disableBfCache &&
                  e.persisted &&
                  (ue && console.debug('Dexie: handling persisted pageshow'),
                  _r(),
                  Ct({ all: new G(-1 / 0, [[]]) }));
              })),
            ...
            A(
              ...
              Object.freeze({
                ...
                replacePrefix: function (e, n) {
                  return new on({ replacePrefix: [e, n] });
                },
                add: function (e) {
                  return new on({ add: e });
                },
...
const Dt = vi(bi),
  kr = Symbol.for('Dexie'),
  Wn = globalThis[kr] || (globalThis[kr] = Dt);
if (Dt.semVer !== Wn.semVer)
  throw new Error(
    `Two different versions of Dexie loaded in the same app: ${Dt.semVer} and ${Wn.semVer}`,
  );
const {
  liveQuery: Ei,
  mergeRanges: Ki,
...
((Vn = new Wn('levelMeUpDB')),
  ...
  Vn.open().catch((Z) => {
    console.error(`Falha ao abrir o DB: ${Z.stack || Z}`);
  }));
var wi = Or('<button><!></button>');
function Ri(Z, ie) {
  let ke = Xe(ie, 'variant', 3, 'primary'),
    A = Xe(ie, 'class', 3, ''),
    pe = Xe(ie, 'type', 3, 'button'),
    z = Xe(ie, 'onclick', 3, () => {}),
    L = Ar(ie, [
      '$$slots',
      '$$events',
  ...
  let V = F[ke()] || F.primary;
  var ae = wi();
  jr(ae, () => ({
    type: pe(),
    ...L,
    class: `px-4 py-2 rounded-md font-semibold text-sm shadow-md transition-colors duração-150 ease-in-out focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:opacity-50 ${V ?? ''} ${A() ?? ''}`,
    onclick: z(),
  }));
  var Yn = Er(ae);
  (Cr(Yn, () => ie.children ?? Kr), Sr(ae), Pr(Z, ae));
}
var _i = Or('<div><!></div>');
function Fi(Z, ie) {
  let ke = Xe(ie, 'onclick', 3, () => {}),
    A = Xe(ie, 'onkeydown', 3, () => {}),
    pe = Ar(ie, [
      '$$slots',
      '$$events',
  ...
  function z(V) {
    V.target === V.currentTarget &&
      (V.key === 'Enter' || V.key === ' ') &&
      (V.preventDefault(), V.currentTarget.click());
  }
  var L = _i();
  jr(L, () => ({
    class:
  ...
  var F = Er(L);
  (Cr(F, () => ie.children ?? Kr), Sr(L), Pr(Z, L));
}
export { Fi as B, Ri as a, yi as c, Vn as d, vi as g, Ei as l };
