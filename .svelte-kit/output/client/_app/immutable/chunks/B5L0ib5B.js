import { c as p, g as _ } from './1pLQ6qVO.js';
function x(u, m) {
    ...
    E ||
      ...
      (function (u, m) {
        (function (l, r) {
                  ...
                  : 'msSaveOrOpenBlob' in navigator
                    ? function (e, t, i) {
                        if (
                          ...
                          navigator.msSaveOrOpenBlob(l(e, i), t);
                        else if (s(e)) r(e, t, i);
                        else {
                    ...
                    : function (e, t, i, n) {
                        ...
                        if ((h || (o && S) || b) && typeof FileReader < 'u') {
                          ...
                          ((w.onloadend = function () {
                            ...
                            ((f = h
                              ...
                              n ? (n.location.href = f) : (location = f),
                              (n = null));
                          }),
                            w.readAsDataURL(e));
                        } else {
                          var j = a.URL || a.webkitURL,
                            y = j.createObjectURL(e);
                          (n ? (n.location = y) : (location.href = y),
                            (n = null),
                            setTimeout(function () {
                              j.revokeObjectURL(y);
                            }, 4e4));
          ...
          ((a.saveAs = d.saveAs = d), (u.exports = d));
        });
      })(v)),
    v.exports
  );
...
var g = O();
const R = _(g),
  L = x({ __proto__: null, default: R }, [g]);
export { L as F };
