import { $ as y, a0 as S, L as w, a1 as P, X as b } from './nNZc3isi.js';
function E(e, r) {
  return e === r || e?.[b] === r;
}
function p(e = {}, r, o, h) {
  ...
  q = function (r, o, h) {
    ...
    if (o && o.length > 0) {
      ...
      const a = document.getElementsByTagName('link'),
        ...
        m = s?.nonce || s?.getAttribute('nonce');
      c = k(
        o.map((t) => {
          if (((t = $(t, h)), t in v)) return;
          v[t] = !0;
          const l = t.endsWith('.css'),
            u = l ? '[rel="stylesheet"]' : '';
          if (h)
            for (let f = a.length - 1; f >= 0; f--) {
              const d = a[f];
              if (d.href === t && (!l || d.rel === 'stylesheet')) return;
            }
          else if (document.querySelector(`link[href="${t}"]${u}`)) return;
          const i = document.createElement('link');
          if (
            ((i.rel = l ? 'stylesheet' : L),
            l || (i.as = 'script'),
            (i.crossOrigin = ''),
            (i.href = t),
            m && i.setAttribute('nonce', m),
