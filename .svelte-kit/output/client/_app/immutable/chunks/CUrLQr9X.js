        ...
        (function (Un, C) {
          ...
          function Te(e, n) {
            (typeof n == 'function' && (n = n(Ie(e))),
              (typeof Reflect > 'u' ? z : Reflect.ownKeys)(n).forEach(
                function (t) {
                  he(e, t, n[t]);
                },
              ));
            ...
            return {
              from: function (n) {
                return (
                  ...
                  he(e.prototype, 'constructor', e),
                  { extend: Te.bind(null, e.prototype) }
                );
              },
            };
          }
...
`)
          ...
          function Fe(e, n) {
            ((this.name = 'BulkError'),
              ...
              (this.message = qt(e, this.failures)));
          }
          (qe(Re)
            .from(Error)
            .extend({
 ...
 ` + o
                      ...
                      : typeof i == 'object' &&
                        ((this.message = ''
                          ...
                          .concat(i.message)),
                        (this.inner = i))
                    : ((this.message = Er[n] || t), (this.inner = null)));
              }
          ...
          ((A.Syntax = SyntaxError),
            (A.Type = TypeError),
            (A.Range = RangeError));
          var Bt = He.reduce(function (e, n) {
              return ((e[n + 'Error'] = A[n]), e);
            }, {}),
            dn = re.reduce(function (e, n) {
              return (
                  ...
                  return (
                    ...
                    i &&
                      (this.onsuccess = this.onsuccess
                        ...
                        : i),
                    o &&
                      (this.onerror = this.onerror ? xe(o, this.onerror) : o),
                    r === void 0 ? (t === void 0 ? void 0 : t) : ee(r, t)
                  );
                };
          }
          function Dr(e, n) {
          ...
          ((dn.ModifyError = hn), (dn.DexieError = Re), (dn.BulkError = Fe));
          var ie =
            typeof location < 'u' &&
          ...
          var Xe = {},
            ...
            ke = ke[2],
            re = re && re.then,
            Oe = He && He.constructor,
            Qn = !!ke,
            Je = function (e, n) {
              (Ze.push([e, n]), pn && (queueMicrotask(Tr), (pn = !1)));
            },
            Gn = !0,
            pn = !0,
            Pe = [],
          ...
          function K(e) {
            ...
            if (typeof e != 'function') {
              if (e !== Xe) throw new TypeError('Not a function');
              return (
                (this._state = arguments[1]),
                (this._value = arguments[2]),
                void (this._state === !1 && Jn(this, this._value))
              );
            }
            ((this._state = null),
              (this._value = null),
              ...
              function t(r, i) {
                var o = this,
                  ...
                  c = new K(function (l, p) {
                    Zn(o, new Mt(Ut(r, e, a, u), Ut(i, e, a, u), l, p, e));
                  });
                return (
          ...
          function Nt(e) {
            var n = e._listeners;
            e._listeners = [];
            for (var t = 0, r = n.length; t < r; ++t) Zn(e, n[t]);
            var i = e._PSD;
            (--i.ref || i.finalize(),
              Ee === 0 &&
                (++Ee,
            ...
            try {
              ...
              (!n._state && yn.length && (yn = []),
                ...
                n._state ||
                  yn.indexOf(i) !== -1 ||
                  (function (o) {
                    for (var a = Pe.length; a; )
                      if (Pe[--a]._value === o._value) return Pe.splice(a, 1);
                  })(n),
                t.resolve(r));
            } catch (o) {
              t.reject(o);
            } finally {
              (--Ee == 0 && et(), --t.psd.ref || t.psd.finalize());
            }
          }
          function Tr() {
            Ke(de, function () {
          ...
          function Ne() {
            ...
            do
              for (; 0 < Ze.length; )
                for (e = Ze, Ze = [], t = e.length, n = 0; n < t; ++n) {
                  var r = e[n];
                  r[0].apply(null, r[1]);
                }
            while (0 < Ze.length);
          ...
          function et() {
            ...
            for (var n = vn.slice(0), t = n.length; t; ) n[--t]();
          }
          function mn(e) {
            return new K(Xe, !1, e);
          }
          function N(e, n) {
            ...
            return function () {
              var r = Me(),
                i = j;
              try {
                return (ve(t, !0), e.apply(this, arguments));
              } catch (o) {
                n && n(o);
              } finally {
                (ve(i, !1), r && Ne());
          ...
          (Te(K.prototype, {
            then: Hn,
            _then: function (e, n) {
              Zn(this, new Mt(null, null, e, n, j));
            },
            catch: function (e) {
              ...
              return typeof n == 'function'
                ? this.then(null, function (r) {
                    return (r instanceof n ? t : mn)(r);
                  })
                : this.then(null, function (r) {
                    return (r && r.name === n ? t : mn)(r);
                  });
            },
            finally: function (e) {
              return this.then(
            ...
            typeof Symbol < 'u' &&
              Symbol.toStringTag &&
              he(K.prototype, Symbol.toStringTag, 'Dexie.Promise'),
            (de.env = Lt()),
            Te(K, {
              all: function () {
                var e = se.apply(null, arguments).map(_n);
            ...
            Oe &&
              ...
              Oe.withResolvers && (K.withResolvers = Oe.withResolvers)));
          var Y = { awaits: 0, echoes: 0, id: 0 },
            qr = 0,
            gn = [],
            bn = 0,
            wn = 0,
          ...
          function Le() {
            return (Y.id || (Y.id = ++qr), ++Y.awaits, (Y.echoes += Ft), Y.id);
          }
          function ye() {
            return (
              !!Y.awaits &&
              (--Y.awaits == 0 && (Y.id = 0), (Y.echoes = Y.awaits * Ft), !0)
            );
          }
          function _n(e) {
            return Y.echoes && e && e.constructor === Oe
              ? (Le(),
                e.then(
                  function (n) {
                    return (ye(), n);
          ...
          function ve(e, n) {
            var t,
              r = j;
            ((n ? !Y.echoes || (bn++ && e === j) : !bn || (--bn && e === j)) ||
              queueMicrotask(
                n
                  ? function (i) {
                      (++wn,
                        (Y.echoes && --Y.echoes != 0) ||
                          (Y.echoes = Y.awaits = Y.id = 0),
                        gn.push(j),
                        ve(i, !0));
                    }.bind(null, e)
                  : Rr,
            ...
            return typeof e != 'function'
              ...
              : function () {
                  ...
                  try {
                    ...
                    (ve(i, !1), r && queueMicrotask(ye));
                  }
                };
          }
          function nt(e) {
            Promise === Oe && Y.echoes === 0
              ? bn === 0
                ? e()
                : enqueueNativeMicroTask(e)
              : setTimeout(e, 0);
          }
          ('' + re).indexOf('[native code]') === -1 && (Le = ye = F);
          var U = K.reject,
            Se = '￿',
            ce =
          ...
          function kn(e) {
            return typeof e != 'string' || /\./.test(e)
              ...
              : function (n) {
                  return (
                    n[e] === void 0 && e in n && delete (n = we(n))[e],
                    n
                  );
                };
          }
          ...
          var en =
            ((Qt.prototype.execute = function (e) {
              var n = this['@@propmod'];
              if (n.add !== void 0) {
                var t = n.add;
                if (L(t)) return ln(ln([], L(e) ? e : [], !0), t).sort();
          ...
          function Gt(e, n) {
            for (var t = z(n), r = t.length, i = !1, o = 0; o < r; ++o) {
              var a = t[o],
                u = n[a],
                c = ue(e, a);
              u instanceof en
                ? (Z(e, a, u.execute(c)), (i = !0))
                : c !== u && (Z(e, a, u), (i = !0));
            }
            return i;
          }
          var Xt =
            ((M.prototype._trans = function (e, n, t) {
            ...
            (M.prototype.update = function (e, n) {
              return typeof e != 'object' || L(e)
                ...
                : ((e = ue(e, this.schema.primKey.keyPath)),
                  e === void 0
                    ? U(
            ...
            (M.prototype.clear = function () {
              ...
              return this._trans('readwrite', function (n) {
                return e.core
                  .mutate({ trans: n, type: 'deleteRange', range: zt })
                  .then(function (t) {
                    return On(e, null, t);
                  });
              }).then(function (n) {
          ...
          function En(e, n, t, r) {
            var i = e.replayFilter ? je(e.filter, e.replayFilter()) : e.filter;
            if (e.or) {
              var o = {},
                a = function (u, c, l) {
                  var p, s;
              ...
              return Promise.all([
                e.or._iterate(a, t),
                Jt(Ht(e, r, t), e.algorithm, a, !e.keysOnly && e.valueMapper),
              ]);
            }
            return Jt(
              Ht(e, r, t),
          ...
          var Fr =
            ...
            (R.prototype._addAlgorithm = function (e) {
              var n = this._ctx;
              n.algorithm = je(n.algorithm, e);
            }),
            (R.prototype._iterate = function (e, n) {
              return En(this._ctx, e, n, this._ctx.table.core);
            }),
            ...
            (R.prototype.toArray = function (e) {
              ...
              return this._read(function (t) {
                var r = n._ctx;
                if (r.dir === 'next' && Ve(r, !0) && 0 < r.limit) {
                  var i = r.valueMapper,
            ...
            (R.prototype.filter = function (e) {
              ...
              return (
                ...
                ((n = this._ctx).isMatch = je(n.isMatch, e)),
                this
              );
            }),
            ...
            (R.prototype.primaryKeys = function (e) {
              var n = this._ctx;
              if (n.dir === 'next' && Ve(n, !0) && 0 < n.limit)
                    ...
                    function y(g) {
                      ...
                      return (
                        ...
                        if (!h)
                          for (var O = 0; O < b; ++O) {
                            var S = x[O],
                              I = { value: we(S), primKey: d[g + O] };
                            i.call(I, I.value, I) !== !1 &&
                              (I.value == null
                                ? E.push(d[g + O])
                                : a || B(u(S), u(I.value)) === 0
                                  ? (_.push(I.value), a && k.push(d[g + O]))
                                  : (E.push(d[g + O]), P.push(I.value)));
                          }
          ...
          function ne(e, n, t) {
            return (
              (e = e instanceof nr ? new e.Collection(e) : e),
              ...
              e._addAlgorithm(function (h, d, y) {
                ...
                for (var b = null, w = f; w < s; ++w) {
                  var x = (function (P, _, k, E, O, S) {
                    for (
                      var I = Math.min(P.length, E.length), T = -1, q = 0;
                      q < I;
                      ++q
                    ) {
                      var te = _[q];
                      if (te !== E[q])
                        return O(P[q], k[q]) < 0
                          ...
                          : O(P[q], E[q]) < 0
                            ...
                            : 0 <= T
                              ? P.substr(0, T) + _[T] + k.substr(T + 1)
                              : null;
                      O(P[q], te) < 0 && (T = q);
                    }
                    return I < E.length && S === 'next'
                      ? P + k.substr(P.length)
                      : I < P.length && S === 'prev'
                        ? P.substr(0, k.length)
                        : T < 0
                          ? null
                          : P.substr(0, T) + E[T] + k.substr(T + 1);
                  })(m, g, u[w], c[w], a, l);
                  x === null && b === null
                    ? (f = w + 1)
                    : (b === null || 0 < a(b, x)) && (b = x);
          ...
          var nr =
            ...
            (W.prototype.between = function (e, n, t, r) {
              ((t = t !== !1), (r = r === !0));
              try {
            ...
            (W.prototype.anyOf = function () {
              ...
              if (n.length === 0) return ze(this);
              var r = new this.Collection(this, function () {
                return me(n[0], n[n.length - 1]);
              });
            ...
            (W.prototype.inAnyRange = function (m, n) {
              var t = this,
                r = this._cmp,
                i = this._ascending,
                o = this._descending,
              ...
              var f = 0,
                ...
                m = new this.Collection(this, function () {
                  return me(p[0][0], p[p.length - 1][1], !c, !l);
                });
              return (
          ...
          function oe(e) {
            return N(function (n) {
              return (rn(n), e(n.target.error), !1);
            });
          }
          function rn(e) {
          ...
          var on = 'storagemutated',
            ...
            Lr =
              ...
              (ae.prototype._unlock = function () {
                if (($e(!j.global), --this._reculock == 0))
                  for (
              ...
              (ae.prototype.create = function (e) {
                ...
                return (
                  $e(this._completion._state === null),
                  ((e = this.idbtrans =
                    e ||
                  ...
                  (e.oncomplete = N(function () {
                    ((n.active = !1),
                      n._resolve(),
                      'mutatedParts' in e &&
                        ge.storagemutated.fire(e.mutatedParts));
                  })),
                  this
                );
              }),
                  ...
                  return new Promise(function (x, P) {
                    ...
                    if (m === 'deleteRange') {
                      ...
                      if (E)
                        ...
                        for (X = 0; X < S; ++X)
                          (T.push((O = _[m](D[X]))), (O.onerror = I));
                    }
                    function Mn(H) {
                      ((H = H.target.result),
                        T.forEach(function (De, Kt) {
                          return De.error != null && (q[Kt] = De.error);
                        }),
                        x({
                          numFailures: te,
                          failures: q,
                        ...
                        D
                          ? ((D.___id = ++Ur),
                            ...
                            (D.start = function (G) {
                              ...
                              var Mn = new Promise(function (H, De) {
                                ((H = N(H)),
                                  (O.onerror = oe(De)),
                                  (D.fail = De),
                                  (D.stop = function (Kt) {
          ...
          function Sn(e, r) {
            var t = r.db,
              r = zr(e._middlewares, t, e._deps, r);
            ((e.core = r.dbcore),
                            ...
                            ? (p.forEach(function (m) {
                                (d.push(function () {
                                  ...
                                  (w.add.forEach(function (E) {
                                    ht(h, E[0], E[1].primKey, E[1].indexes);
                                  }),
                                  ...
                                  if (x && m._cfg.version > v) {
                                    (Sn(s, h), (f._memoizedTables = {}));
                                    var P = Dt(b);
                                    (w.del.forEach(function (E) {
                                      P[E] = g[E];
                                    }),
                                      lt(s, [s.Transaction.prototype]),
                                      jn(s, [s.Transaction.prototype], z(P), P),
                                      (f.schema = P));
                                    var _,
                                      k = Yn(x);
                                    return (
          ...
          function Cn(e, n, t) {
            var r = {};
            return (
              fn(n.objectStoreNames, 0).forEach(function (i) {
                for (
          ...
          var Qr =
            ((Ye.prototype._createTableSchema = st),
            (Ye.prototype._parseIndexSyntax = or),
            (Ye.prototype._parseStoresSpec = function (e, n) {
              var t = this;
              z(e).forEach(function (r) {
                if (e[r] !== null) {
                  ...
                  if (((o.unique = !0), o.multi))
                    throw new A.Schema('Primary key cannot be multiEntry*');
            ...
            (Ye.prototype.stores = function (t) {
              var n = this.db;
              this._cfg.storesSource = this._cfg.storesSource
                ? ee(this._cfg.storesSource, t)
                : t;
              var t = n._versions,
                r = {},
                i = {};
            ...
            (Ye.prototype.upgrade = function (e) {
              return (
                (this._cfg.contentUpgrade = $n(
                  this._cfg.contentUpgrade || F,
                  e,
                )),
                this
              );
          ...
          function dt(e, n) {
            ...
            return (
              t ||
                (t = e._dbNamesDB =
                  new le(xn, { addons: [], indexedDB: e, IDBKeyRange: n }))
                  .version(1)
                  .stores({ dbnames: 'name' }),
              t.table('dbnames')
            );
          ...
          function sn(e, n, t) {
            ...
            if (!isNaN(r)) {
              ...
              if (vt(e)) return ee(e, { from: n, to: t, d: 1 });
              var i = e.l,
                r = e.r;
              if (B(t, e.from) < 0)
                return (
          ...
          function ar(e, n) {
            ...
            if (r.done) return !1;
            for (
              var i = r.value, o = In(e), a = o.next(i.from), u = a.value;
              !r.done && !a.done;
                  ...
                  : (e[t] = (function r(i) {
                      ...
                      for (o in i)
                        J(i, o) &&
                          ((a = i[o]),
                          (u[o] =
                            !a || typeof a != 'object' || Tt.has(a.constructor)
                              ? a
                              : r(a)));
                      return u;
                    })(n[t]));
          ...
          function Gr(e) {
            ...
            function u() {
              return new K(function (v, f) {
                ...
                ((d.onerror = oe(f)),
                  (d.onblocked = N(e._fireOnBlocked)),
                  (d.onupgradeneeded = N(function (y) {
                    var m;
                    ((p = d.transaction),
                  ...
                  (d.onsuccess = N(function () {
                      ...
                      try {
                        ...
                        if (n.autoSchema)
                          ((m = x),
                            ...
                            (g = y._dbSchema = Cn(0, m, g)),
                            (y._storeNames = fn(m.objectStoreNames, 0)),
                            jn(y, [y._allTables], z(g), g));
                        else if (
                          (Dn(e, e._dbSchema, _),
                          ((w = ft(Cn(0, (w = e).idbdb, _), w._dbSchema)).add
                            .length ||
                    ...
                    (Ue.push(e),
                      (x.onversionchange = N(function (k) {
                ...
                return (
                  ...
                  K.resolve(
                    ...
                    if (0 < n.onReadyBeingFired.length) {
                      var f = n.onReadyBeingFired.reduce($n, F);
                      return (
                        (n.onReadyBeingFired = []),
                        K.resolve(
                          yt(function () {
                        ...
                        return Object.create(m, {
                          continue: {
                            value: function (g) {
                              g != null
                                ? m.continue(
                                    Bn(g, s.reverse ? e.MAX_KEY : e.MIN_KEY, f),
                                  )
                                : s.unique
                                  ? m.continue(
                                      m.key
                          ...
                          continuePrimaryKey: {
                            value: function (g, b) {
                              m.continuePrimaryKey(Bn(g, e.MAX_KEY, f), b);
                            },
                          },
                          primaryKey: {
                            get: function () {
                        ...
                        return (
                          (s =
                            s.type === 'add' || s.type === 'put'
                              ? C(C({}, s), { keys: y })
                              : C({}, s)).type !== 'delete' &&
                            (s.values = ln([], s.values)),
                          s.keys && (s.keys = ln([], s.keys)),
                          (v = t),
                          (h = y),
                          ((f = s).type === 'add'
                            ? Promise.resolve([])
          ...
          function lr(e, n, t) {
            try {
              ...
              for (
                ...
                B(n.keys[i], e[o]) === 0 &&
                  (r.push(t ? we(n.values[i]) : n.values[i]), ++o);
                ...
                table: function (n) {
                  ...
                  return C(C({}, t), {
                    getMany: function (r) {
                      ...
                      var i = lr(r.keys, r.trans._cache, r.cache === 'clone');
                      return i
                        ? K.resolve(i)
            ...
            create: function (e) {
              ...
              return C(C({}, e), {
                ...
                table: function (r) {
                        ...
                        return (
                            ...
                            ? (w.addKeys(_),
                              ...
                              (E || k) &&
                                ...
                                o.indexes.forEach(function (O) {
                                  ...
                                  function T(q) {
                                    return O.multiEntry && L(q)
                                      ? q.forEach(function (te) {
                                          return S.addKey(te);
                                        })
                                      : S.addKey(q);
                                  }
                                  (y || m).forEach(function (q, G) {
                                    var D = y && I(y[G]),
                                      G = m && I(m[G]);
                                    B(D, G) !== 0 &&
                                      (D != null && T(D), G != null && T(G));
                                  });
                                })))
                            : _
                              ? ((k = {
                          ...
                          i.mutate(f).then(function (O) {
                            return (
                              ...
                              (g.mutatedParts = Tn(g.mutatedParts || {}, b)),
                              O
                            );
                          })
                        );
                  ...
                  return (
                    z(v).forEach(function (f) {
                      p[f] = function (h) {
                        var d = j.subscr,
                          y = !!d,
                          m = fr(j, i) && hr(f, h) ? (h.obsSet = {}) : d;
                        if (y) {
                          var g = function (k) {
                              return (
                                (k = 'idb://'
                          ...
                          if (
                            ...
                            if (f !== 'count') {
                              var x =
                                ...
                                c &&
                                h.values &&
                                i.query(C(C({}, h), { values: !1 }));
                              return i[f]
                                .apply(this, arguments)
                                .then(function (k) {
                                  if (f === 'query') {
                                    if (c && h.values)
                                      return x.then(function (I) {
                                        return (
                                          (I = I.result),
                                          b.addKeys(I),
                                          k
            ...
            var a = n.query.index,
              ...
              v = v.reduce(function (f, h) {
                ...
                if (h.type === 'add' || h.type === 'put')
                  for (var m = new Q(), g = h.values.length - 1; 0 <= g; --g) {
                    var b,
                      w = h.values[g],
                      x = l(w);
                    m.hasKey(x) ||
              ...
              return C(C({}, e), {
                                ...
                                if (u._explicit && c && u.mutatedParts)
                                  for (
                                    ...
                                    for (
                                      ...
                                      mt((_ = b[g]).obsSet, u.mutatedParts) &&
                                        (_e(P, _),
                ...
                table: function (t) {
                  ...
                  return C(C({}, r), {
                        ...
                        ? ((a = r.mutate(o)),
                          ...
                          !(
                            ...
                            ? (u.optimisticOps.push(o),
                              o.mutatedParts && qn(o.mutatedParts),
                              a.then(function (c) {
                                0 < c.numFailures &&
                                  (_e(u.optimisticOps, o),
                                  (c = dr(0, o, c)) && u.optimisticOps.push(c),
                                  o.mutatedParts && qn(o.mutatedParts));
                              }),
                              a.catch(function () {
                                (_e(u.optimisticOps, o),
                    ...
                    query: function (o) {
                      if (!fr(j, r) || !hr('query', o)) return r.query(o);
                      var a =
                        ...
                        c = s.signal,
                        l = (function (h, d, y, m) {
                          var g = Ae['idb://'.concat(h, '/').concat(d)];
                          if (!g) return [];
                          ...
                          switch (y) {
                            case 'query':
                              var w = b.find(function (x) {
                                return (
                                  ...
                                  yr(x.req.query.range, m.query.range)
                                );
                              });
                              return w
                                ? [w, !0, g, b]
                                : [
                                    b.find(function (x) {
                                      return (
                                        ...
                                        ei(x.req.query.range, m.query.range)
                                      );
                                    }),
                                    !1,
                                    g,
                            ...
                            case 'count':
                              return (
                                (w = b.find(function (x) {
                                  return yr(x.req.query.range, m.query.range);
                                })),
                                [w, !!w, g, b]
                              );
                          }
                      ...
                      return (
                        p && s
                          ...
                          : ((s = r
                              ...
                              .catch(function (h) {
                                return (f && p && _e(f, p), Promise.reject(h));
                              })),
                            (p = {
                              obsSet: o.obsSet,
                              promise: s,
                        ...
                        p.promise.then(function (h) {
                          return {
                            result: pr(h.result, o, v?.optimisticOps, r, p, a),
                          };
                        })
                      );
                    },
          ...
          var le =
            ((V.prototype.version = function (e) {
              if (isNaN(e) || e < 0.1)
            ...
            (V.prototype._close = function () {
              ...
              var e = this._state,
                n = Ue.indexOf(this);
              if ((0 <= n && Ue.splice(n, 1), this.idbdb)) {
                try {
                  this.idbdb.close();
                } catch {}
                this.idbdb = null;
                ...
                function a() {
                  ...
                  ((u.onsuccess = N(function () {
                    ...
                    ((c = n._deps),
                      ...
                      (p = c.indexedDB),
                      (c = c.IDBKeyRange),
                      pt(p) || l === xn || dt(p, c).delete(l).catch(F),
                      i());
                  })),
                    (u.onerror = oe(o)),
            ...
            Object.defineProperty(V.prototype, 'tables', {
              get: function () {
                var e = this;
                ...
                return K.resolve().then(function () {
                  ...
                  return (
                    ...
                    (d = K.follow(function () {
                      ...
                      (m = h.call(y, y)) &&
                        (g
                          ? ((b = ye.bind(null, null)), m.then(b, b))
          ...
          function V(e, n) {
            ...
            ((l.dbReadyPromise = new K(function (s) {
              ...
              (this.Collection =
                ...
                tn(Fr.prototype, function (m, y) {
                  ...
                  this._ctx = {
                    ...
                    error: h,
                    or: d.or,
                    valueMapper: m !== Ge ? m : null,
                  };
                }))),
              (this.Table =
                ((o = this),
                tn(Xt.prototype, function (s, v, f) {
                  ((this.db = o),
                    (this._tx = f),
                    (this.name = s),
                    (this.schema = v),
              ...
              (this.Transaction =
                ((a = this),
                tn(Lr.prototype, function (s, v, f, h, d) {
                  var y = this;
                  (s !== 'readonly' &&
              ...
              (this.WhereClause =
                ((c = this),
                tn(nr.prototype, function (s, v, f) {
                  if (
                    ((this.db = c),
                    (this._ctx = {
                      table: s,
            ...
            var p = new Proxy(this, {
              get: function (s, v, f) {
                ...
                if (v === 'table')
                  return function (d) {
                    return Rn(t.table(d), p);
                  };
                var h = Reflect.get(s, v, f);
                return h instanceof Xt
                  ? Rn(h, p)
                  : v === 'tables'
                    ? h.map(function (d) {
                        return Rn(d, p);
                    ...
                    : v === '_createTransaction'
                      ? function () {
                          return Rn(h.apply(this, arguments), p);
                        }
                      : h;
              },
            });
                  ...
                  p = {
                    ...
                    unsubscribe: function () {
                      u ||
                        ((u = !0),
                        a && a.abort(),
                        s && ge.storagemutated.unsubscribe(f));
                    },
                  };
                i.start && i.start(p);
                var s = !1,
          ...
          function Et(e) {
            var n = be;
            try {
              ((be = !0), ge.storagemutated.fire(e), wt(e, !0));
            } finally {
              be = n;
            }
          }
          (Te(
            ...
            C(C({}, dn), {
              delete: function (e) {
                return new Ce(e, { addons: [] }).delete();
              },
              exists: function (e) {
                return new Ce(e, { addons: [] })
                  .open()
                  .then(function (n) {
                    return (n.close(), !0);
                  })
              ...
              ignoreTransaction: function (e) {
                return j.trans ? Ke(j.transless, e) : e();
              },
              vip: yt,
              async: function (e) {
                return function () {
              ...
              waitFor: function (e, n) {
                return (
                  (n = K.resolve(
                    typeof e == 'function' ? Ce.ignoreTransaction(e) : e,
                  ).timeout(n || 6e4)),
            ...
            (Ce.maxKey = an(Ce.dependencies.IDBKeyRange)),
          ...
          return (
            typeof BroadcastChannel < 'u' &&
              ((mr = function () {
                (We = new BroadcastChannel(at)).onmessage = function (e) {
                  return e.data && Et(e.data);
                };
              })(),
              typeof We.unref == 'function' && We.unref(),
              ge(on, function (e) {
                be || We.postMessage(e);
              })),
            typeof addEventListener < 'u' &&
            ...
            C(
              ...
              Object.freeze({
                ...
                replacePrefix: function (e, n) {
                  return new en({ replacePrefix: [e, n] });
                },
                add: function (e) {
                  return new en({ add: e });
                },
...
const St = oi(si),
  br = Symbol.for('Dexie'),
  Ln = globalThis[br] || (globalThis[br] = St);
if (St.semVer !== Ln.semVer)
  throw new Error(
    `Two different versions of Dexie loaded in the same app: ${St.semVer} and ${Ln.semVer}`,
  );
const {
  liveQuery: fi,
  mergeRanges: hi,
