...
const A = globalThis.__sveltekit_6tz5by?.base ?? '',
  Ot = globalThis.__sveltekit_6tz5by?.assets ?? A ?? '',
  $t = '1762408468168',
...
function we(e, t, n) {
  ...
  const r = e instanceof SVGAElement ? e.target.baseVal : e.target,
    ...
    o = a?.origin === Ae && e.hasAttribute('download');
...
function ue(e, t, n) {
  return e.origin !== Ae || !e.pathname.startsWith(t)
    ? !0
    : n
      ? !(
          e.pathname === t + '/' ||
...
async function dn(e, t, n) {
  (globalThis.__sveltekit_6tz5by?.data && globalThis.__sveltekit_6tz5by.data,
...
async function ht(e, t, n, a, r) {
  return e.origin === Ae && e.pathname === location.pathname && !st
...
export { dn as a, cn as l, k as p, C as s };
