...
import { o as De } from './D5tPhTvi.js';
const V = [];
function ke(e, t = he) {
  let n = null;
  const a = new Set();
...
const L = globalThis.__sveltekit_1lzh0t4?.base ?? '',
  Ot = globalThis.__sveltekit_1lzh0t4?.assets ?? L ?? '',
  $t = '1762363239089',
...
function te(e) {
  ...
  for (; s && s !== document.documentElement; )
    (a === null && (a = z(s, 'preload-code')),
      r === null && (r = z(s, 'preload-data')),
      t === null && (t = z(s, 'keepfocus')),
      n === null && (n = z(s, 'noscroll')),
      i === null && (i = z(s, 'reload')),
      o === null && (o = z(s, 'replacestate')),
      (s = Qe(s)));
  function c(l) {
    switch (l) {
      case '':
  ...
  return {
    preload_code: ze[a ?? 'off'],
    preload_data: ze[r ?? 'off'],
    keepfocus: c(t),
    noscroll: c(n),
    reload: c(i),
    replace_state: c(o),
...
const Vt = new Set(['icon', 'shortcut icon', 'apple-touch-icon']),
  q = We(He) ?? {},
  H = We(Ye) ?? {},
  C = { url: Be({}), page: Be({}), navigating: ke(null), updated: Ct() };
function Ue(e) {
  q[e] = le();
}
function zt(e, t) {
...
async function hn(e, t, n) {
  (globalThis.__sveltekit_1lzh0t4?.data && globalThis.__sveltekit_1lzh0t4.data,
    ...
    y ||
      ((y = x = Date.now()),
      history.replaceState({ ...history.state, [B]: y, [W]: x }, '')));
  const a = q[y];
  function r() {
...
async function Ce({ status: e, error: t, url: n, route: a }) {
  ...
  try {
    ...
    if (o instanceof Ee) return Mt(new URL(o.location, location.href), {}, 0);
    throw o;
  }
}
async function Xt(e) {
...
async function fe(e, t) {
  if (e && !ue(e, L, v.hash)) {
    ...
    for (const r of Te) {
      const i = r.exec(a);
      if (i)
        return { id: ce(e), invalidating: t, route: r, params: yt(i), url: e };
    }
  }
}
function Qt(e) {
...
async function K({
  ...
  if (oe) {
    const b = (
      await Promise.all(Array.from(Bt, (P) => P(g.navigation)))
    ...
    const D = S && (await S);
    (D ? (E = D.commit()) : (Oe.$set(d.props), nt(d.props.page), (E = mt?.())),
      (it = !0));
...
function Zt() {
  ...
  const r = new IntersectionObserver(
    (s) => {
      for (const c of s)
        c.isIntersecting && (me(new URL(c.target.href)), r.unobserve(c.target));
    },
    { threshold: 0 },
  );
...
function tn() {
  ((history.scrollRestoration = 'manual'),
    addEventListener('beforeunload', (t) => {
      let n = !1;
      if ((Ge(), !X)) {
        const a = je(_, void 0, null, 'leave'),
          r = {
            ...a.navigation,
            cancel: () => {
    ...
    O.addEventListener('click', async (t) => {
      ...
      if (f !== void 0 && h) {
        ...
        if (((M = !0), Ue(y), e(a), !s.replace_state)) return;
        M = !1;
      }
      (t.preventDefault(),
        await new Promise((w) => {
...
export { hn as a, L as b, ln as l, k as p, C as s };
